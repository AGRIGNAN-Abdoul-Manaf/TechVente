{{-- MESSAGE D’ERREURS --}}
@if ($errors->any())
<div style="background:#ffdddd; padding:10px; border-left:5px solid red; margin-bottom:15px; border-radius:6px;">
...
<form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="form-card">
    ...
    <label for="imageInput" class="btn btn-primary cursor-pointer w-full text-center">
